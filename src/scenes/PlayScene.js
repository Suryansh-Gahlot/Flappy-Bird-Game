...
class PlayScene extends BaseScene {
    constructor(config) {
        ...
        this.difficulty = {
            ...
            'normal': {
                pipeHorizontalDistanceRange: [300, 330],
                PipeVerticalDistanceRange: [140, 190]
            },
            'hard': {
                pipeHorizontalDistanceRange: [280, 310],
    ...
    placePipe(uPipe, lPipe) {
        ...
        let PipeVericalPosition = Phaser.Math.Between(0 + 20, this.config.height - 20 - PipeVerticalDistance);
